...
public class KakaoRestApiHelper {
    ...
    static {
        ...
        // 유저/어드민 둘 다 있지만 서버사이드의 경우 어드민으로 접근해야 한다.
    ...
    public String getUserInfoByUserId(Long id) {
        Map<String, String> params = new HashMap<>();
        params.put("target_id_type", "user_id");
        params.put("target_id", id.toString());
        return request(HttpMethodType.GET, USER_ME_PATH, "?" + mapToParams(params));
    }
    ...
    public String getUserTokenInfo() {
        return request(USER_TOKEN_INFO_PATH);
    }
